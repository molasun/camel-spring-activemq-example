...
public class AMQToFileRoute extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        from("activemq:queue:my-queue").id("amq-consumer").routeId("activemq-file-route")
                // Multicast EIP allows to route the same message to a multiple endpoints &
                // process them in a different way
                // main difference between the Multicast and Splitter is that Splitter will
                // split the message into several pieces
